...
| batchDispatchOptions | Batch dispatch options. If provided, will be passed to the configured [`INoticeBatchIo`](../INoticeBatchIo.md). Optional. |
...
This overload generates unique identifiers for the notices. If *TEnterpriseEventBaseType* extends [`EnterpriseEvent`](../EnterpriseEvent.md), then [`Id`](../EnterpriseEvent/Id.md) is used; otherwise, a new Guid is generated.
