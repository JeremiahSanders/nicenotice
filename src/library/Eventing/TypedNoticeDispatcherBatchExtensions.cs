...
public static class TypedNoticeDispatcherBatchExtensions
{
  ...
  ///   the result using
  ///   <see cref="Jds.NiceNotice.ITypedNoticeDispatcher{TEnterpriseEventBaseType}.DispatchBatchAsync{TEventType}" />.
  /// </summary>
  /// <remarks>
  ...
  /// <summary>
  ///   Creates a <see cref="Jds.NiceNotice.DispatchBatchRequest" />
  ///   which sends all the provided <paramref name="notices" />
  ///   to the provided <paramref name="stream" />
  ///   and sends the result using
  ///   <see cref="Jds.NiceNotice.ITypedNoticeDispatcher.DispatchBatchAsync" />.
  /// </summary>
